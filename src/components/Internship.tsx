...
function Internship() {
    ...
    //     </section>
    // );
        <CollapsibleSection title="Internships" defaultOpen>
            <div className="space-y-8 p-1">
                {Internships.map((internship, index) => (
                <div
                    key={index}
                    className="p-6 border border-gray-200 rounded-lg shadow-sm transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:border-indigo-300 hover:border-4"
                >
